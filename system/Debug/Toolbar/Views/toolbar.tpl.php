...
<div id="debug-bar">
	...
	<div id="ci-timeline" class="tab">
		<table class="timeline">
			...
			<tbody>
			<?php echo $this->renderTimeline($collectors, $startTime, $segmentCount, $segmentDuration,
				$styles) ?>
			</tbody>
		</table>
	</div>
	...
	<div id="ci-vars" class="tab">
		...
		<?php if (isset($vars['varData'])) : ?>
			<?php foreach ($vars['varData'] as $heading => $items) : ?>
				...
				<a href="javascript:void(0)" onclick="ciDebugBar.toggleDataTable('<?php echo strtolower(str_replace(' ',
