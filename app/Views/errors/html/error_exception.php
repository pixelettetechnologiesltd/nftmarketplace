...
<body onload="init()">
	...
	<!-- Source -->
	<div class="container">
		<p><b><?php echo static::cleanPath($file, $line) ?></b> at line <b><?php echo esc($line) ?></b></p>
						...
						<p>
							...
							<?php if (isset($row['class'])) : ?>
								...
								<?php if (! empty($row['args'])) : ?>
									...
									( <a href="#" onclick="return toggle('<?php echo esc($args_id) ?>');">arguments</a> )
									<div class="args" id="<?php echo esc($args_id) ?>">
										<table cellspacing="0">
				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td><?php echo esc($request->isAJAX()) ? 'yes' : 'no' ?></td>
						</tr>
						<tr>
							<td>Is CLI Request?</td>
							<td><?php echo esc($request->isCLI()) ? 'yes' : 'no' ?></td>
						</tr>
						<tr>
							<td>Is Secure Request?</td>
							<td><?php echo esc($request->isSecure()) ? 'yes' : 'no' ?></td>
						</tr>
						<tr>
							<td>User Agent</td>
