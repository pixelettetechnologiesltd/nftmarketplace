                                    ...
                                    <span class="like-btn">
                                        <button class="like-wrap text-muted d-flex align-items-center fw-semi-bold favorite_item" id="favorite_item" nftId="<?php echo esc($nft->nftId); ?>" favoriteVal="<?php echo esc($nft->favoriteVal); ?>">
                                            <svg class="like-icon_<?php echo esc($nft->nftId); ?> <?php if ($nft->favoriteActive == 1) {
                                                                                                        echo "like-active";
                                                                                                    } ?>" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
            ...
            <div class="collection-card-carousel owl-carousel owl-theme">
                <a class="bg-white collection-card d-block p-3 rounded-7">
                    <div class="d-flex masonry-wrap">
                        ...
                        <div class="masonry-end d-flex flex-column ms-1">
                            <img src="<?php echo base_url() . '/public/assets/dist/img/avatar/avatar-1.png'; ?>" class="masonry-img-sm">
                            <div class="masonry-devider mt-1"></div><img src="<?php echo base_url() . '/public/assets/dist/img/avatar/avatar-1.png'; ?>" class="masonry-img-sm">
                        </div>
                    </div>
                </a>
            </div>
