                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-4 pt-2">
                                        ...
                                        if ($userId != $nftInfo->user_id) {
                                            ...
                                            if ($nftInfo->auction_type == 'Fix' && $nftInfo->nft_status!='stake') {
                                        ...
                                        ?>
                                                    ...
                                                    <form action='<?php echo base_url("user/nft_stack/{$nftInfo->nftId}/{$nftInfo->nftId}/{$nftInfo->contract_address}") ?>' method="post">
                                                    <input type="submit" value="NFT Stake"  class="btn btn-l btn-pills btn-outline-primary me-2 bid-btn mt-2"><i class="mdi mdi-gavel fs-5 me-2"></i>
                                                </form>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           <?php
                                                } else {    
                                                ?>
                                ...
                                <div class="col-12">
                                    <ul class="nav nav-tabs border-bottom" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="detail-tab" data-bs-toggle="tab" data-bs-target="#detailItem" type="button" role="tab" aria-controls="detailItem" aria-selected="true"><?php echo display('Details'); ?></button>
                                        </li>

                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="bids-tab" data-bs-toggle="tab" data-bs-target="#bids" type="button" role="tab" aria-controls="bids" aria-selected="false"><?php echo display('Bids'); ?></button>
                                        </li>

                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="info-tab" data-bs-toggle="tab" data-bs-target="#info" type="button" role="tab" aria-controls="info" aria-selected="false"><?php echo display('Blockchain_Info'); ?></button>
                                        </li>
                                    </ul>
                                            ...
                                            <div class="row mt-0 g-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="creators creator-primary d-flex align-items-center">
                                                        ...
                                                        <div class="ms-3">
                                                            <h6 class="mb-0 fw-semi-bold"><a href="<?php echo base_url('nft') . '/' . $nftInfo->username; ?>" class="text-dark name"><?php echo esc($nftInfo->f_name) . ' ' . esc($nftInfo->l_name); ?></a></h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- Category -->
