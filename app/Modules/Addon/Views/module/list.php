                    ...
                    <div class="card-body">
                        ...
                        <?php echo form_close() ?>
                            ...
                            <div class="row">
                                ...
                                $def_mods = ['Account','Auth','CMS','Common','Addon','Exchange','Finance','System_user','User','Website', 'Nfts', 'Setting', 'Report'];
                                if (is_array($map))
...
<link href="<?php echo base_url('/app/Modules/Addon/assets/ajaxs/addons/sweetalert/sweetalert.css'); ?>" rel="stylesheet">
<script src="<?php echo base_url().'/app/Modules/Addon/assets/ajaxs/addons/sweetalert/sweetalert.min.js'; ?>" type="text/javascript"></script>
