...
if(SSS !== 0){
   define('UPDATE_INFO_URL','https://update.bdtask.com/nftbox/autoupdate/update_info');
    //Get Update file
    define('MIN_VERSION', file_get_contents('https://update.bdtask.com/nftbox/autoupdate/update_min_version'));
    //Get Update file
    define('MAX_VERSION', file_get_contents('https://update.bdtask.com/nftbox/autoupdate/update_max_version'));

    //Get Update file
    define('UPDATE_URL','https://update.bdtask.com/nftbox/autoupdate');
